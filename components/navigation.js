...
export default function Navigation() {
  ...
  const navLinks = (
    navs.map(nav => {
      ...
      return (
        <div className="navigation-link-dropdown navigation-link">
  ...
  return (
    <Navbar expand="lg" className="nav-main">
      <div className="container navbar-container">
        ...
        <svg id="listIcon" className="dropdownIcon" onClick={() => toggleDropdown()}
          xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#66Fcf1" class="bi bi-list" viewBox="0 0 16 16">
          <path fill-rule="evenodd"
            d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
        </svg>

        <div className="dropdown-container">
          <div className={show ? "dropdown-outside" : null} onClick={() => toggleDropdown()} />
          <div className={show ? 'customDropdown dropDownShow' : 'customDropdown dropDownHide'}>
