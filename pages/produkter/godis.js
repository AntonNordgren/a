...
export default function Godis() {
  return (
    <Container fluid >
      <Row>
        <Col className="p-4">
          <Card style={{borderRadius: "2px", boxShadow: "gray 7px 7px 5px"}}>
            <Card.Img variant="top" style={{width: "80%", margin: "auto", padding: "0px"}} src="https://img.reklambutiken.com/products/cba82c612a8a91593da51590db824596/large/Bilda%CC%88gg%2035%20cm.jpg" />
            <Card.Body>
